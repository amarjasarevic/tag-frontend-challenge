(function() {
  ...
  function hasElementAtPosition(x, y) {
  ...
  function updateElementsPosition(element, level) {
  ...
  function getRandomArray(maxElements) {
    const array = [];
  ...
  function generateInitialArray(level) {
    const tiles = [];
    const maxElements = Math.pow(2, level);
  ...
  function handleListClick(level) {
